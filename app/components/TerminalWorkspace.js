...
function ExnessPrice({ value, digits, className }) {
        ...
        <aside className={styles.ticket}>
          ...
          <div className={styles.dealRow}>
            <button className={cx(styles.dealBox, styles.sellDeal)} onClick={() => placeOrder("Sell")}>
              ...
              <ExnessPrice value={sell} digits={active.digits} className={styles.dealPrice} />
            </button>
            ...
            <button className={cx(styles.dealBox, styles.buyDeal)} onClick={() => placeOrder("Buy")}>
              ...
              <ExnessPrice value={buy} digits={active.digits} className={styles.dealPrice} />
            </button>
          </div>
