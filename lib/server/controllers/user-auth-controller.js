...
export async function userMeController() {
  ...
  // createdAt so the profile page can show a real "member since" instead of an
  // invented date. Still no passwordHash — toPublicUser stripped it, and this
  // list is explicit about what leaves the server.
  return json({
    user: {
      id: user.id,
